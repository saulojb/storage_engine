...
-- Transition and final functions for vectorized aggregates.
-- The second argument of each sfunc receives a VectorColumn*
-- pointer at runtime (from VectorTupleTableSlot), so it is
-- declared with the matching column type but treated as a
-- raw pointer inside the C implementation.
-- =========================================================
