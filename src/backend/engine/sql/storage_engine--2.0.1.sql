-- storage_engine--2.0.1.sql
--
-- Direct installation script for storage_engine v2.0.1
-- Generated by combining storage_engine--1.0.sql with all upgrade scripts up to v2.0.1.
