-- storage_engine--2.4.0.sql
--
-- Direct installation script for storage_engine v2.4.0
-- Generated by combining storage_engine--1.0.sql with all upgrade scripts up to v2.4.0.
-- Use this file for fresh installations of v2.4.0.
--
...
-- (no catalog changes — vectorized aggregate improvements only)
-- =============================================================================
-- Additions for v2.4.0
-- (no catalog changes — planner, cache, and executor behavior improvements only)
-- =============================================================================
